                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="mt-5 fs-4 text-white animated zoomIn">Selamat datang di <strong
                                            class="text-dark"> Sistem Informasi Pertanian (SIP)</strong></p>
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="mt-5 fs-4 text-white animated zoomIn">Selamat datang di <strong
                                            class="text-dark"> Sistem Informasi Pertanian
                                            (SIP)</strong></p>
                                    <h1 class="display-3 text-dark mb-4 animated zoomIn">Temukan solusi pertanian cerdas
                                        dan berkelanjutan di sini</h1>
                                </div>
            ...
            <div class="row">
                <div class="col wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title text-center">
                        ...
                        <h1 class="display-6" style="font-size: xx-large;">Sistem Informasi Pertanian</h1>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-sm-10 text-center">
                            <p class="mb-0" style="font-size: 1.2rem; line-height: 2rem">Sistem Informasi Pertanian adalah website yang berfungsi untuk membantu petani. Sistem ini dapat membantu dalam mengatasi masalah pertanian. Petani dapat gunakan ini untuk hasil panen yang lebih baik. Sistem ini membantu pertanian lebih efisien dan petani mendapat hasil lebih banyak.</p>
                        </div>
                    </div>
                </div>
            </div>
