    ...
    <div class="card border-left-primary text-dark shadow h-100 p-4">
        <div class="card-body">
            ...
            <form action="{{ route('store.information') }}" method="POST" class="mb-3 d-none" id="profile-edit-mode">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none" name="kota"
                                autocomplete="address-level2" name="kota" value="{{ $kota }}" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control shadow-none"
                                autocomplete="email" value="{{ auth()->user()->email }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="custom-select shadow-none" name="jenis_kelamin" id="jk">
                ...
                <button type="button" class="btn btn-light p-2 mt-3" id="btn-cancel">Cancel</button>
                <button type="submit" class="btn btn-secondary p-2 mt-3">Simpan</button>
            </form>
        </div>
    </div>
</div>
